...
- **Pronouns**: She/they (undergoing GAHT)[^2]
[^2]: GAHT: Gender-Affirming Hormone Therapy. DIY HRT since 2023-10-12, GAHT since 2026-02-09 (Peking University Third Hospital).

- **Studies**: Accounting Professional Qualification (Assistant Accountant); CPA (including CAATs with SQL/Python) on the way.[^3]
[^3]: CPA: Certified Public Account; CAATs: Computer-Assisted Audit Techniques.

- **Languages**: Chinese, English (B1/B2), Japanese (N5 & Kanbun Kundoku), Esperanto, Hangul, etc.

- **Games**: Minecraft, Terraria & WarThunder, etc.[^4]
[^4]: Minecraft JEID: XiaYiGongHeQiu; BEID: XiaYGHQiu.<br>
